// ══════════════════════════════════════════════════════════════════
//  buildStandingsForSeed — the sort everything else is downstream of
// ══════════════════════════════════════════════════════════════════
//
// The highest-leverage pure function in the app: the Standings page rank, the
// playoff seed map, the auto-seed pairings and bracket positioning all read it.
// A regression here ripples through the entire UI.
//
// In particular this pins the May 8 regression — two teams tied 2-0-0 on
// different holes-won totals, where the 4th-step tiebreaker was dropped and
// standings showed the wrong team at #1 before anybody caught it.
//
