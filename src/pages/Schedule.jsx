...
export default function ScheduleView({ schedule, teams, players, matchResults, leagueUser, leagueConfig }) {
  ...
  return (
    <div>
      ...
      {/* My Schedule column header + calendar button */}
      {myOnly && (
        <>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
            <div style={{ display: "flex", alignItems: "center", padding: "0 12px", fontSize: 9, color: K.t3, fontWeight: 700, textTransform: "uppercase", letterSpacing: .8, flex: 1 }}>
          ...
          <button onClick={addAllToCalendar} style={{
            ...
            width: "100%", padding: "9px", borderRadius: 8, cursor: "pointer", marginBottom: 10,
