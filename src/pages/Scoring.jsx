...
import { GroupScoring, PlayerScoreCard, ScoringToast } from "../components/GroupScoring";
  ...
  return (
    <div style={{ maxWidth: 420, margin: "0 auto" }}>
      ...
      {/* Full Scorecard button — sits above the current-hole banner so
          ...
          Doubles as the sign entry point: once every player has all 9
          holes (allComplete), this button promotes to a prominent blue
          "Complete — Sign Scorecard" CTA that opens the finalize/sign
      ...
      {/* Sign entry point lives on the Full Scorecard button above (it
          promotes to "Complete — Sign Scorecard" when allComplete). The
          standalone duplicate button that used to sit here was removed. */}
