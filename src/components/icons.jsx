// ══════════════════════════════════════════════════════════════════
//  icons.jsx — the Lucide-style stroke icon set.
// ══════════════════════════════════════════════════════════════════
//
// Its own file rather than part of ui.jsx, for the same reason ui.jsx is its
// own file rather than part of theme: `I` is a map of draw functions, not a
// component, and a module that exports both is one Fast Refresh cannot reload
// cleanly — which is what react-refresh/only-export-components is telling you.
//
// Each entry takes (size, colour) and returns an <svg>, so call sites read
// I.trophy(18, K.acc) rather than <Trophy size={18} color={K.acc} />. Keep that
// shape: EmptyState looks icons up BY NAME off this object.
