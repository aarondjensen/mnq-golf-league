...
export const getCSS = (k) => `
  * { box-sizing: border-box; margin: 0; padding: 0; -webkit-tap-highlight-color: transparent; }
  ...
  .app-body { flex: 1; }
  .main-content { padding: 12px 14px; padding-bottom: 120px; max-width: 900px; width: 100%; margin: 0 auto; box-sizing: border-box; }
  ...
  @media (min-width: 768px) {
    .main-content { padding: 24px 32px; padding-bottom: 120px; margin: 0 auto; }
